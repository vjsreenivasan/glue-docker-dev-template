...
def init_debugger():
    ...
    if os.environ.get("ENABLE_DEBUG") == "true":
        try:
            ...
            print("👉 ACTION REQUIRED: In VS Code, select 'Python: Attach to Glue Job' and press Play (F5) to resume execution.")
...
def remove_null_columns(df, threshold=0.5):
    ...
    for column in df.columns:
        ...
        if null_percentage <= threshold:
            ...
            print(f"Removing column {column} with {null_percentage*100:.2f}% null values")
